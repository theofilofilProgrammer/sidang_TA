...
<head>
    ...
    <title>Tambahkan Data Berita | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
    ...
    <div class="d-flex main-content-wrapper">
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="form-data-section container col-lg-12 d-flex flex-column justify-content-center py-5 px-5 mx-0 my-5">
                <h3 class="section-title mb-4">TAMBAHKAN DATA BERITA</h3>
                <form>
                    ...
                    <div class="d-flex justify-content-center px-2 mt-4">
                        ...
                        <a href="/data-berita" class="btn btn-danger col-4 py-3">BATAL</a>
                    </div>
                </form>
            </section>
        </div>
