...
<head>
    ...
    <title>Edit Data Berita | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
...
<body>
    ...
    <div class="d-flex main-content-wrapper">
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="form-data-section container col-lg-12 d-flex flex-column justify-content-center py-5 px-5 mx-0 my-5">
                <h3 class="section-title mb-4">Edit Data Berita : Workshop Pengembangan Web Laravel</h3>
                <form>
                    <hr class="batas-form my-4"> <!-- Garis pemisah -->    
                    <div class="form-group">
                        <label for="nama-berita">Nama Berita</label>
                        <input type="text" class="form-control" id="nama-berita" placeholder="Silahkan mengisi Judul Berita">
                    </div>

                    <div class="form-group">
                        <label for="tanggalberita">Tanggal Berita</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="tanggalberita" placeholder="dd/mm/yyyy" aria-label="Tanggal Lahir" aria-describedby="calendar-icon">
                            <div class="input-group-append">
                                <span class="input-group-text" id="calendar-icon"><i class="far fa-calendar-alt"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="deskripsiBerita" rows="3" placeholder="Silahkan mengisi Deskripsi Berita"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="dokumentasiBerita">Dokumentasi</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="dokumentasiBerita" accept="image/jpeg,image/png,image/gif,image/svg+xml">
                                <label class="custom-file-label" for="dokumentasiBerita">Pilih file (jpg, png, jpeg, svg)</label>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="d-flex justify-content-between px-0 mt-4">
                        ...
                        <a href="/data-berita" class="btn btn-danger col-5 py-3" style="font-size: 1.25rem;"><i class="far fa-window-close mr-2"></i> BATAL</a>
                    </div>
                </form>
            </section>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Untuk input dokumen
            const dokumenInput = document.getElementById('dokumenPengumuman');
            dokumenInput.addEventListener('change', function() {
                const fileName = this.files[0] ? this.files[0].name : 'Pilih file (pdf, docx, dll.)';
            ...
            const dokumentasiInput = document.getElementById('dokumentasiPengumuman');
