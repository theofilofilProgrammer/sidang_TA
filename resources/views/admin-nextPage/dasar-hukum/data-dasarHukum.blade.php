...
<head>
    ...
    <title>Data Dasar Hukum | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
    ...
    <div class="d-flex main-content-wrapper">
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="data-mahasiswa-section container col-lg-12 d-flex flex-column justify-content-center px-0 py-5 mx-0 my-5">
                ...
                <h3 class="section-title mb-4">Pengelolaan Data Dasar Hukum</h3>
                <hr class="col-lg-12 col-md-12 px-0">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="/Add-data-dasar-hukum" class="btn btn-primary add-data-btn px-5 py-3">
                        <i class="fas fa-plus mr-2"></i> Tambah Data Dasar Hukum
                    </a>
                </div>
                <hr class="col-lg-12 col-md-12 px-0">
                    ...
                    <table class="table table-bordered table-striped data-table">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Judul Dasar Hukum</th>
                                <th class="align-middle">Jenis Dasar Hukum</th>
                                <th class="align-middle">Jenis Hukum yang berkaitan dengan Judul</th>
                                <th class="align-middle">Pencipta /Inventor</th>
                                <th class="align-middle">Tahun Dasar Hukum</th>
                                <th class="align-middle">No. Pendaftaran</th>
                                <th class="align-middle px-2 col-2">Aksi (Dasar Hukum)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td>Sistem Informasi Absensi Mahasiswa Berbasis Web</td>
                                <td>HKI</td>
                                <td>HKI (Hak Cipta)</td>
                                <td>Dra. Annisa Putri, M.Kom, Budi Santoso, S.Kom</td>
                                <td>2023</td>
                                <td>C00202301234</td>
                                <td>
                                    <a href="/edit-data-dasar-hukum" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-data-dasar-hukum" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2.</td>
                                <td>Aplikasi Mobile Deteksi Dini Kebakaran Hutan Menggunakan IoT</td>
                                <td>HKI</td>
                                <td>HKI (Hak Cipta)</td>
                                <td>Dr. Cahyo Nugroho, Siti Rahayu, S.T., M.Eng</td>
                                <td>2024</td>
                                <td>C00202405678</td>
                                <td>
                                    <a href="/edit-data-dasar-hukum" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                            ...
                            <tr>
                                <td>3.</td>
                                <td>Metode Pengolahan Citra untuk Deteksi Kerusakan Tanaman Padi Otomatis</td>
                                <td>Paten</td>
                                <td>Paten Sederhana</td>
                                <td>Prof. Dr. Ir. Bima Sakti, Indra Jaya, M.Kom</td>
                                <td>2023</td>
                                <td>S00202309876</td>
                                <td>
                                    <a href="/edit-data-dasar-hukum" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                            ...
                            <tr>
                                <td>4.</td>
                                <td>Desain Antarmuka Pengguna Aplikasi Smart Home</td>
                                <td>HKI</td>
                                <td>HKI (Desain Industri)</td>
                                <td>Rina Kusuma, S.Ds, Fajar Sidik, S.T.</td>
                                <td>2024</td>
                                <td>D00202401122</td>
                                <td>
                                    <a href="/edit-data-dasar-hukum" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
