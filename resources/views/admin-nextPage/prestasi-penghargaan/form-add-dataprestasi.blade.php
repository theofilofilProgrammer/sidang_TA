...
@section('title', 'Tambahkan Data Prestasi & Penghargaan')
...
<div class="content-wrapper col-lg-10 px-0 mx-4">
    <section class="form-data-section container col-lg-12 d-flex flex-column justify-content-center py-5 px-5 mx-0 my-5">
        <h3 class="section-title mb-4">Tambah Data Prestasi / Penghargaan</h3>
        <form action="{{ route('prestasi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul_prestasi_penghargaan" class="form-control @error('judul_prestasi_penghargaan') is-invalid @enderror" id="judul_prestasi_penghargaan" placeholder="Silahkan mengisi Judul Prestasi / Penghargaan" value="{{ old('judul_prestasi_penghargaan') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kategori_prestasi_penghargaan" class="form-control @error('kategori_prestasi_penghargaan') is-invalid @enderror" id="kategori_prestasi_penghargaan" placeholder="Silahkan mengisi kategori Penghargaan" value="{{ old('kategori_prestasi_penghargaan') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tahun_prestasi_penghargaan" class="form-control @error('tahun_prestasi_penghargaan') is-invalid @enderror" id="tahun_prestasi_penghargaan" placeholder="Contoh: 2024" value="{{ old('tahun_prestasi_penghargaan') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi_prestasi_penghargaan" class="form-control @error('deskripsi_prestasi_penghargaan') is-invalid @enderror" id="deskripsi_prestasi_penghargaan" rows="3" placeholder="Silahkan mengisi deskripsi prestasi / Penghargaan">{{ old('deskripsi_prestasi_penghargaan') }}</textarea>
            ...
            <div class="d-flex justify-content-center px-2 mt-4">
                ...
                <a href="{{ route('prestasi.index') }}" class="btn btn-danger col-4 py-3">BATAL</a>
            </div>
        </form>
    </section>
</div>
