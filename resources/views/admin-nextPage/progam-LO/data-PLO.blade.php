...
<head>
    ...
    <title>Data Program Learning Outcome (LO) | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
    ...
    <div class="d-flex main-content-wrapper">
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="data-mahasiswa-section container col-lg-12 d-flex flex-column justify-content-center px-0 py-5 mx-0 my-5">
                ...
                <h3 class="section-title mb-4">Pengelolaan Program Learning Outcome (CPL)</h3>
                <hr class="col-lg-12 col-md-12 px-0">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="/Add-PLO" class="btn btn-primary add-data-btn px-5 py-3">
                        <i class="fas fa-plus mr-2"></i> Tambah Data CPL
                    </a>
                </div>
                <hr class="col-lg-12 col-md-12 px-0">
                    ...
                    <table class="table table-bordered table-striped data-table">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">ID CPL</th>
                                <th class="align-middle">Judul CPL</th>
                                <th class="align-middle px-2 col-2">Aksi (Program Learning Outcome)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td>CPL-01</td>
                                <td>CPL-01: Keterampilan Rekayasa (Engineering Skills)</td>
                                <td>
                                    <a href="/edit-PLO" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-PLO" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
                                </td>
                            </tr>                            
                            <tr>
                                <td>2.</td>
                                <td>CPL-02</td>
                                <td>CPL-02: Analisis dan Perancangan Eksperimen</td>
                                <td>
                                    <a href="/edit-PLO" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-PLO" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
                            ...
                            <tr>
                                <td>3.</td>
                                <td>CPL-03</td>
                                <td>CPL-03: Kerja Tim dan Komunikasi</td>
                                <td>
                                    <a href="/edit-PLO" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-PLO" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
                            ...
                            <tr>
                                <td>4.</td>
                                <td>CPL-04</td>
                                <td>CPL-04: Etika Profesional dan Tanggung Jawab Sosial</td>
                                <td>
                                    <a href="/edit-PLO" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-PLO" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
                            ...
                            <tr>
                                <td>5.</td>
                                <td>CPL-05</td>
                                <td>CPL-05: Penguasaan Bidang Keahlian Spesifik</td>
                                <td>
                                    <a href="/edit-PLO" class="btn btn-sm btn-info edit-btn"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger delete-btn"><i class="fas fa-trash-alt"></i></a>
                                    <a href="/detail-PLO" class="btn btn-sm btn-warning info-btn"><i class="fas fa-info-circle"></i></a>
