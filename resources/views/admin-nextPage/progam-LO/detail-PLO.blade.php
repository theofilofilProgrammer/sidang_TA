...
<head>
    ...
    <title>Detail Data Program Learning Outcome (LO) | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="detail-dataMahasiswa-section container col-lg-12 d-flex flex-column py-5 px-3 mx-0 my-5">
                <div class="d-flex align-items-center mb-4">
                    <a href="/data-PLO" class="btn btn-secondary btn-sm back-button px-3 py-2 mr-5"><i class="fas fa-chevron-left"></i> Kembali</a>
                    <h3 class="section-title mb-0">Judul CPL: CPL-01: Keterampilan Rekayasa (Engineering Skills)</h3>
                </div>
                ...
                <div class="detail-card">
                    <div class="row detail-row">
                        <div class="col-12">
                            <h3 class="detail-subtitle text-center pb-5">CPL-01: Keterampilan Rekayasa (Engineering Skills)</h3>
                            <h4 class="detail-subtitle">Deskripsi utama :</h4>
                            <p class="detail-text">Mampu menerapkan pengetahuan, teknik, keterampilan, dan perangkat modern matematika, sains, engineering, dan teknologi untuk menyelesaikan masalah-masalah rekayasa secara luas pada bidang rekayasanya.</p>
                        </div>
                        <div class="col-12 mt-3">
                            <h4 class="detail-subtitle">Poin-Poin Sub:</h4>
                            <ul class="detail-list">
                                <li>Mampu konsep-konsep rekayasa (engineering sciences), prinsip-prinsip rekayasa (engineering principles), dan perancangan rekayasa yang relevan (engineering design) dalam menyelesaikan masalah-masalah rekayasa pada bidang keahliannya.</li>
                                <li>Mampu mengidentifikasi, merumuskan, dan menyelesaikan masalah rekayasa pada sistem perangkat keras dan lunak komputer melalui penerapan prinsip-prinsip rekayasa.</li>
                                <li>Mampu menggunakan teknik, keterampilan, dan perangkat modern yang diperlukan untuk praktik rekayasa.</li>
                            </ul>
                        </div>
                        <div class="col-12 mt-3">
