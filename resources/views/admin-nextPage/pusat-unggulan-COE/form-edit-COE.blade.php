...
<head>
    ...
    <title>Edit Data Pusat Unggulan (COE) | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
...
<body>
    ...
    <div class="d-flex main-content-wrapper">
        ...
        <div class="content-wrapper col-lg-10 px-0 mx-4">
            <section class="form-data-section container col-lg-12 d-flex flex-column justify-content-center py-5 px-5 mx-0 my-5">
                <h3 class="section-title mb-4">Judul COE : Pusat Keunggulan Teknologi Informasi Berbasis Industri 4.0</h3>
                <form>
                    <div class="form-group">
                        <label for="judulCOE">Judul COE</label>
                        <input type="text" class="form-control" id="judulCOE" placeholder="Silahkan mengisi Judul COE">
                    </div>
                    <div class="form-group">
                        <label for="deskripsiUtamaCOE">Deskripsi Utama COE</label>
                        <textarea class="form-control" id="deskripsiUtamaCOE" rows="3" placeholder="Silahkan mengisi Deskripsi Utama COE"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="poinCOE">Poin-Poin Proyek Unggulan COE (pisahkan dengan baris baru)</label>
                        <textarea class="form-control" id="poinpoinCOE" rows="5"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="emailDosen" placeholder="Silahkan mengisi Email Dosen">
                    </div>
                    <div class="form-group">
                        <label for="gambarCOE">Gambar COE :</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="gambarCOE" accept="image/jpeg,image/png,image/gif,image/svg+xml">
                                <label class="custom-file-label" for="gambarCOE">No File Choosen</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between px-0 mt-4">
                        ...
                        <a href="/data-COE" class="btn btn-danger col-5 py-3" style="font-size: 1.25rem;"><i class="far fa-window-close mr-2"></i> BATAL</a>
                    </div>
                </form>
            </section>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const dokumentasiInput = document.getElementById('gambarCOE');
