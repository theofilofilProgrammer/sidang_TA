...
<head>
    ...
    <title>Lihat Semua Berita | Program Studi D3 Teknologi Informasi PSDKU Politeknik Negeri Pontianak Di Kabupaten Sukamara</title>
    <!-- CSS -->
    ...
    <section class="hero-breadcrumb-section col-lg-12 px-0 d-flex align-items-center mx-0 my-3">
        <div class="container col-12 px-3 d-flex justify-content-between align-items-center">
            ...
            <div class="hero-breadcrumb-title-container col-lg-10 text-left">
                <h3 class="hero-breadcrumb-title ml-4 mb-0">Lihat Semua Berita</h3>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="main-content-card main-content-semuaBerita mb-4 p-4 rounded shadow-sm">
                    ...
                    <h3 class="main-content-title col-12 px-0 text-left">Daftar Lengkap Berita</h3>
                    ...
                    <div class="row col-lg-12 px-0 mb-4 align-items-center">
                        <div class="col-md-10 mb-3 mb-md-0 px-0">
                            <div class="input-group">
                                <input type="search" class="form-control" placeholder="Cari judul Berita, tahun, atau kata kunci..." aria-label="Cari judul, atau kata kunci..." aria-label="Cari nama dosen atau jenis dosen" aria-describedby="search-button">
                        ...
                        <div class="col-md-2 pr-0 pl-3">
                            <select id="tahun_berita" class="form-control">
                    ...
                    <div class="row">
                        <!-- Card 1 Semua Berita: Workshop Pengembangan Web Laravel -->
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="daftar-berita-card text-justify">
                                <img src="images/berita/berita_1.png" class="card-img-top news-card-image" alt="Gambar Berita 7">
                                <div class="card-body py-5">
                                    <h4 class="daftar-berita-title">Seminar Nasional Teknologi Informasi</h4>
                                    <p class="daftar-berita-tanggal"><strong>Tanggal</strong> : 17 Juni 2025</p>
                                    <p class="daftar-berita-paragraf">Deskripsi tentang acara seminar nasional yang baru saja diselenggarakan oleh prodi, menghadirkan pembicara ahli dari industri dan akademisi terkemuka.</p>
                                    <a href="/deskripsi-berita" class="btn btn-baca-selengkapnya-berita mt-auto">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <!-- Card 1 Semua Berita: Workshop Pengembangan Web Laravel -->
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="daftar-berita-card text-justify">
                                <img src="images/berita/berita_1.png" class="card-img-top news-card-image" alt="Gambar Berita 7">
                                <div class="card-body py-5">
                                    <h4 class="daftar-berita-title">Workshop Pengembangan Web Laravel</h4>
                                    <p class="daftar-berita-tanggal"><strong>Tanggal</strong> : 28 Mei 2025</p>
                                    <p class="daftar-berita-paragraf">Penelitian ini membahas perancangan dan implementasi sistem informasi berbasis cloud untuk mengelola usaha kecil menengah (UKM). Sistem ini dirancang untuk meningkatkan efisiensi operasional dan aksesibilitas data bagi pelaku UKM.</p>
                                    <a href="#" class="btn btn-baca-selengkapnya-berita mt-auto">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <!-- Card 1 Semua Berita: Workshop Pengembangan Web Laravel -->
